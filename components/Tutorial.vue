...
<section class="text-gray-600 body-font">
  <div class="container px-5 py-24 mx-auto">
    <div class="flex flex-col text-center w-full mb-20">
      <h2 class="text-xs Text-PrimaryColor tracking-widest font-medium title-font mb-1">ROOF PARTY POLAROID</h2>
    ...
    <div class="flex flex-wrap">
      <div class="xl:w-1/4 lg:w-1/2 md:w-full px-8 py-6 border-l-2 border-gray-200 border-opacity-60">
        ...
        <a class="Text-PrimaryColor inline-flex items-center">Learn More
    ...
    <button class="flex mx-auto mt-16 text-white Bg-PrimaryColor border-0 py-2 px-8 focus:outline-none hover:bg-blue-600 rounded text-lg">Button</button>
  </div>
</section>
</template>
